function [mean_pop_firing_rate, mean_pop_norm_spike_pairs, Vs_traces, Vd_traces, s_traces] = gj_uncorr_input(T0,no_cells,p_gj,max_j,smallvars,p_inhib,inhib_strength)
tic
...
toc
str = ['uncorrsmalldata', num2str(T0), '_', num2str(no_cells),'_',num2str(p_gj),'_',num2str(max_j),'_',num2str(p_inhib),'_',num2str(inhib_strength),'.mat'];
save(str,'','-v7')
if smallvars > 0
    str = ['uncorrbigdata', num2str(T0), '_', num2str(no_cells),'_',num2str(p_gj),'_',num2str(max_j),'_',num2str(p_inhib),'_',num2str(inhib_strength),'.mat'];
